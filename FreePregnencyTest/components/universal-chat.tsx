  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-blue-700 hover:bg-blue-800 text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110"
        style={{ zIndex: 9999 }}
      >
      ...
      {isChatOpen && (
        <div className="fixed bottom-20 right-6 z-50">
          <div className="bg-white rounded-xl shadow-2xl w-96 h-[500px] flex flex-col border">
            <div className="flex items-center justify-between p-4 bg-blue-700 text-white rounded-t-xl">
            ...
            {showForm ? (
              <div className="flex-1 p-4">
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Start Chat
                  </button>
                </div>
              ...
              <>
                ...
                <div className="p-4 bg-blue-700 rounded-b-xl">
                  <div className="flex space-x-2">
                    ...
                    <button 
                      onClick={sendMessage}
                      className="px-3 py-2 bg-white text-blue-700 rounded-lg hover:bg-gray-100"
                    >
