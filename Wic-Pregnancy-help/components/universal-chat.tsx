  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-cyan-600 hover:bg-cyan-700 text-white rounded-full shadow-lg flex items-center justify-center z-50 transition-all duration-300 transform hover:scale-110"
      >
      ...
      {isChatOpen && (
        <div className="fixed bottom-20 right-6 z-50">
          <div className="bg-white rounded-xl shadow-2xl w-96 h-[500px] flex flex-col border">
            <div className="flex items-center justify-between p-4 bg-cyan-600 text-white rounded-t-xl">
            ...
            {showForm ? (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 placeholder-gray-400"
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Start Chat
                  </button>
                </div>
              ...
              <>
                ...
                <div className="p-4 bg-cyan-600 rounded-b-xl">
                  <div className="flex space-x-2">
                    ...
                    <button 
                      onClick={sendMessage}
                      className="px-3 py-2 bg-white text-cyan-600 rounded-lg hover:bg-gray-100"
                    >
