  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 right-4 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-full shadow-lg flex items-center justify-center z-40 transition-all duration-300 transform hover:scale-110"
      >
      ...
      {isChatOpen && (
        <div className="fixed inset-0 sm:inset-auto sm:bottom-20 sm:right-4 z-50 p-0 sm:p-0">
          <div className="bg-white rounded-none sm:rounded-xl shadow-2xl w-full h-full sm:w-80 md:w-96 sm:h-[500px] flex flex-col border-0 sm:border">
            <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-t-none sm:rounded-t-xl">
            ...
            {showForm ? (
              <div className="flex-1 p-3 sm:p-4">
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-2 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg hover:from-pink-600 hover:to-purple-600 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                  >
                    Start Chat
                  </button>
                </div>
              ...
              <>
                ...
                <div className="p-2 sm:p-4 bg-gradient-to-r from-pink-500 to-purple-500 rounded-b-none sm:rounded-b-xl">
