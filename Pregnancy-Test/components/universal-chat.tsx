  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-r from-emerald-600 to-orange-600 hover:from-emerald-700 hover:to-orange-700 text-white rounded-full shadow-lg flex items-center justify-center z-50 transition-all duration-300 transform hover:scale-110"
      >
      ...
      {isChatOpen && (
        <div className="fixed bottom-20 right-6 z-50">
          <div className="bg-white rounded-xl shadow-2xl w-96 h-[500px] flex flex-col border">
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-emerald-600 to-orange-600 text-white rounded-t-xl">
            ...
            {showForm ? (
              <div className="flex-1 p-4">
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-gradient-to-r from-emerald-600 to-orange-600 text-white rounded-lg hover:from-emerald-700 hover:to-orange-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Start Chat
                  </button>
                </div>
              ...
              <>
                ...
                <div className="p-4 bg-gradient-to-r from-emerald-600 to-orange-600 rounded-b-xl">
