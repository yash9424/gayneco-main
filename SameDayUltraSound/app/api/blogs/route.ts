export async function GET() {
  try {
    ...
    const filteredBlogs = data.filter(blog => {
      ...
      const matches = blog.projects.includes('SameDayUltraSound')
      console.log(`Blog "${blog.title}" projects:`, blog.projects, 'matches SameDayUltraSound:', matches)
      return matches
    })
    console.log('Filtered blogs for SameDayUltraSound:', filteredBlogs.length)
